...
INSERT INTO `discount_amount` VALUES (1,'Clearance sale',15,'%'),(2,'DBS Cardholders',5,'%'),(3,'SP Students Sale',2,'%'),(4,'Clearance sale',15,'%'),(5,'Weekend Sale',500,'$'),(6,'Weekendsale',500,'$'),(7,'adsadasd',50,'%'),(8,'Razer 1 week sale',20,'%'),(9,'20% Off - Chinese New Year Sale',20,'%'),(10,'Audio Technica Sale',10,'%');
